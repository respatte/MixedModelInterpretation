	...
	\begin{center}
		\invisible<1>{
			...
			\begin{tikzpicture}[scale = .26]
				...
				\only<9->{
					\draw[dashed, gray] (7.75, 15.75) -- (16.25, 15.75);
					\draw[thick, color=param2, -] (16.25, 15.75) -- (16.25, 16.1) node[pos=.5, right]{PrePost};
				}
				\only<10->{\draw[thick, color=param1, -] (16.25, 16.1) -- (16.25, 16.3) node[above]{Intervention};}
