...
\begin{frame}[fragile]{ANOVA and regression results}
	...
	\begin{block}{Regression results}
		...
		\hline
		(Intercept)                              &  150.703 &      3.725 &    40.453 & $<2\mathrm{e}{-16}$ \\
		Intervention\uncover<4>{Video Game}   &    2.484 &      5.269 &     0.472 & 0.638               \\
		PrePost\uncover<4>{Post Intervention} & -106.182 &      5.269 &   -20.154 & $<2\mathrm{e}{-16}$ \\
		Intervention:PrePost                     &   90.960 &      7.451 &    12.172 & $<2\mathrm{e}{-16}$ \\
		\end{tabular}
	\end{block}
